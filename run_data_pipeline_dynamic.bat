...
:: ==============================================================================
:: InSAR-Gated GNNExplainer Data Pipeline - DYNAMIC MODE
:: Description: Processes raw data and builds datasets for Post-Fire Dynamic analysis.
::              Does NOT include model training.
:: ==============================================================================

set MODE=dynamic
set CONFIG=metadata/dataset_config_dynamic.yaml
